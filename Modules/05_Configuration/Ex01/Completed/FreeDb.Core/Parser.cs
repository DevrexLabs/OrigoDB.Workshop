...
namespace XmcdParser
{
    public class Parser
    {
        readonly List<Tuple<Regex, Action<Disc, MatchCollection>>> actions = new List<Tuple<Regex, Action<Disc, MatchCollection>>>();
        ...
        public Parser()
        {
            ...
            Add("DISCID=(.+)", (disk, collection) =>
            {
                ...
                disk.DiscIds.AddRange(strings.Select(x => x.Trim()));
            });
